...
![An illustration representing an order confirmation screen on iPhone. The screen includes buttons titled 'Create Account' and 'Sign up with Apple'.](https://docs-assets.developer.apple.com/published/070bebe44bfc929cb0a55aea519b58fe/create-account-after-purchase%402x.png)
...
![An illustration of a button that includes the Apple logo and text that reads 'Sign in with Apple'.](https://docs-assets.developer.apple.com/published/68e67ffce381af81217dc78d8b6bdd8a/apple-account-sign-in-with%402x.png)

![An illustration of a button that includes the Apple logo and text that reads 'Sign up with Apple'.](https://docs-assets.developer.apple.com/published/ac6400acf45924b55c58dbb5822df9df/apple-account-sign-up-with%402x.png)

![An illustration of a button that includes the Apple logo and text that reads 'Continue with Apple'.](https://docs-assets.developer.apple.com/published/e83e39fa01dcc2df9fe07bc4720f1198/apple-account-continue-with%402x.png)
...
![An illustration of a 'Sign in with Apple' button with 90-degree corners.](https://docs-assets.developer.apple.com/published/ac43a67ff1974596f65f1623570e1d4e/apple-account-minimum-corner-radii%402x.png)

![An illustration of a 'Sign in with Apple' button with the default corner radius.](https://docs-assets.developer.apple.com/published/68e67ffce381af81217dc78d8b6bdd8a/apple-account-default-corner-radii%402x.png)

![An illustration of a 'Sign in with Apple' button with the maximum corner radius, which results in a capsule-like appearance.](https://docs-assets.developer.apple.com/published/f6fe501845edcbafbd12252fccad4a99/apple-account-maximum-corner-radii%402x.png)
...
![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 44 points and a font size of 19 points.](https://docs-assets.developer.apple.com/published/9d8162b89693bc88063cfccff2e667eb/left-aligned-correct-proportions-2%402x.png)

![An illustration of a Sign in with Apple button, with callouts that indicate a button height of 56 points and a font size of 24 points.](https://docs-assets.developer.apple.com/published/1b2b54ad1a793ea0cfbbeaf3bd508713/left-aligned-correct-proportions-1%402x.png)
...
![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has rounded corners.](https://docs-assets.developer.apple.com/published/cf38cc2dce92249deee69ea5e7e7609f/siwa-logo-masked-rounded-rect%402x.png)

![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button has square corners.](https://docs-assets.developer.apple.com/published/73295df26d012b44d8628dbc637a44bc/siwa-logo-default%402x.png)

![An illustration of a logo-only Sign in with Apple button. The button includes only the Apple logo, and the button is circular.](https://docs-assets.developer.apple.com/published/ccf70e86f1e8dff04dde905c845120d9/siwa-logo-masked-circle%402x.png)
