...
![An illustration of a scanning sheet on iPhone, which includes the text Ready to Scan and Hold your device near the NFC tag, and a Cancel button.](https://docs-assets.developer.apple.com/published/ca6c2d77f483a8a68fec37c894c6f952/nfc-ready-to-scan%402x.png)
...
![An illustration of a notification banner above the Home screen on iPhone, which offers an opportunity to open a specific app to process NFC tag data detected nearby.](https://docs-assets.developer.apple.com/published/b182c191a5f4c655048d2736614775de/nfc-background%402x.png)
