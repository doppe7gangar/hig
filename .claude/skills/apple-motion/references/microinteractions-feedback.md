...
.apple-btn {
  ...
  padding: 12px 20px;
  border-radius: 10px;
  background: #0088FF;   /* iOS system blue */
  color: #fff;
  font-weight: 600;
  cursor: pointer;
  user-select: none;
